...
object ShareUtils {
    ...
    fun sharePdfUri(context: Context, uri: android.net.Uri) {
    ...
    fun openFolder(context: Context, file: File) {
        try {
            ...
            if (relativePath != null) {
                val folderUri = android.net.Uri.parse("content://com.android.externalstorage.documents/document/primary:${relativePath.replace("/", "%2F")}")
                val intent = Intent(Intent.ACTION_VIEW).apply {
