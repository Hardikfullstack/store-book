...
public fun SyncPurchaseItemMutation.ref(
    ...
    id: String,storeId: String,purchaseId: String,itemId: String,itemName: String,quantity: Double,unit: String,buyPrice: Double,isDeleted: Boolean,updatedAt: Double,
