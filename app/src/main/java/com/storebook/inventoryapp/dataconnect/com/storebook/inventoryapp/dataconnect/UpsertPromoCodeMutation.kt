        ...
        public fun build(
          ...
          return object : Builder {
            ...
            override var discountPercent: Double?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { discountPercent = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
              
            override var discountAmount: Double?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { discountAmount = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
              
            override var maxUses: Double?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { maxUses = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
              
            override var expiresAt: Double?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { expiresAt = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
