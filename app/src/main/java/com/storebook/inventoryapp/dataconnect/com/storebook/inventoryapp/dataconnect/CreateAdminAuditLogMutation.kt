  ...
  public data class Variables(
    ...
    Double
      ...
      public companion object {
        ...
        public fun build(
          adminId: String,action: String,timestamp: Double,
          block_: Builder.() -> Unit
        ): Variables {
          var adminId= adminId
          ...
          return object : Builder {
            override var adminId: String
              ...
              set(value_) { adminId = value_ }
              
            override var adminUsername: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { adminUsername = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
              
            override var action: String
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { action = value_ }
              
            override var targetId: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { targetId = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
              
            override var details: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { details = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
