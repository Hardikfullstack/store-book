  ...
  public data class Variables(
    ...
    com.google.firebase.dataconnect.OptionalVariable<Boolean?>
      ...
      public companion object {
        ...
        public fun build(
          id: String,role: String,createdAt: Double,storeId: String,
          block_: Builder.() -> Unit
        ): Variables {
          var id= id
            var role= role
          ...
          return object : Builder {
            ...
            override var canViewProfit: Boolean?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { canViewProfit = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
              
            override var canDelete: Boolean?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { canDelete = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
