  ...
  public data class Variables(
    ...
    Double
      ...
      public companion object {
        ...
        public fun build(
          id: String,storeId: String,itemId: String,quantity: Double,costPrice: Double,timestamp: Double,isDeleted: Boolean,updatedAt: Double,
          block_: Builder.() -> Unit
        ): Variables {
          var id= id
            var storeId= storeId
          ...
          return object : Builder {
            ...
            override var itemId: String
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { itemId = value_ }
              
            override var batchNumber: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { batchNumber = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
