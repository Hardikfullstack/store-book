...
public fun GetUsersPaginatedQuery.ref(): com.google.firebase.dataconnect.QueryRef<
    GetUsersPaginatedQuery.Data,
    Unit,
> =
    ref(
...
public suspend fun GetUsersPaginatedQuery.execute(): com.google.firebase.dataconnect.QueryResult<
    GetUsersPaginatedQuery.Data,
    Unit,
> =
    ref().execute()

public fun GetUsersPaginatedQuery.flow(): kotlinx.coroutines.flow.Flow<GetUsersPaginatedQuery.Data> =
    ref()
        .subscribe()
        .flow
