        ...
        val lang =
            try {
                ...
                if (com.storebook.inventoryapp.BuildConfig.DEBUG) {
                    android.util.Log
                        .d("MainActivity", "attachBaseContext read lang: $l")
                }
                l
            } catch (e: Exception) {
                ...
                if (com.storebook.inventoryapp.BuildConfig.DEBUG) {
                    android.util.Log
                        .e("MainActivity", "attachBaseContext read error", e)
                }
                "en"
            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isPremium =
                remember {
                    mutableStateOf(
                        storebookPrefs.getBoolean("is_premium", false) ||
                            storebookPrefs.getString("user_role", "owner") == "staff",
                    )
                }
