...
import com.storebook.inventoryapp.shared.data.local.GeneratePriceDriftReport
...
fun PriceDriftReportScreen(
    ...
    val pctCorrect = if (totalLineItemsCount > 0) {
                ...
                item {
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            if (hasAnyDrift) {
                                Text(
                                    text = "$pctCorrect% of sale-line prices match current catalog prices. " +
                                            "$currentDriftCount line(s) show a price change since billed — normal after updating prices.",
                                    fontSize = 12.sp,
                ...
                item {
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Text(
                                text = "When you bill a sale, each line item saves the sellPrice and buyPrice at that moment. If you later change an item's selling price, old SaleItem records are NOT affected.\n\nThis report compares every recorded line against today's catalog price and flags any differences — proving your financial data is accurate and untampered.",
                                fontSize = 12.sp,
...
@Composable
private fun PriceLabel(title: String, value: String, accent: Boolean = false) {
