        ...
        mutableStateOf(
            try {
                AppThemeMode.valueOf(
                    prefs.getString(KEY_THEME_MODE, AppThemeMode.INK_BLUE.name) ?: AppThemeMode.INK_BLUE.name,
                )
            } catch (e: Exception) {
...
private val LightColorScheme =
    lightColorScheme(
        ...
        tertiary = InkBlue300, // CTA accent
...
// Sunset Orange Mode
private val SunsetOrangeLightColorScheme =
    lightColorScheme(
...
private val SunsetOrangeDarkColorScheme =
    darkColorScheme(
...
// Forest Green Mode
private val ForestGreenLightColorScheme =
    lightColorScheme(
...
private val ForestGreenDarkColorScheme =
    darkColorScheme(
...
private val AmethystPurpleLightColorScheme =
    lightColorScheme(
...
private val AmethystPurpleDarkColorScheme =
    darkColorScheme(
...
// Crimson Ruby Mode
private val CrimsonRubyLightColorScheme =
    lightColorScheme(
...
private val CrimsonRubyDarkColorScheme =
    darkColorScheme(
...
private val CharcoalObsidianLightColorScheme =
    lightColorScheme(
...
private val CharcoalObsidianDarkColorScheme =
    darkColorScheme(
    ...
    val colorScheme =
        when (themeMode) {
            ...
            AppThemeMode.AMETHYST_PURPLE ->
                if (darkTheme) AmethystPurpleDarkColorScheme else AmethystPurpleLightColorScheme
            ...
            AppThemeMode.CHARCOAL_OBSIDIAN ->
                if (darkTheme) CharcoalObsidianDarkColorScheme else CharcoalObsidianLightColorScheme
        }
