...
data class BackupInfo(
    ...
    fun formattedDate(): String =
        android.text.format.DateFormat
            .format("dd MMM yyyy HH:mm", java.util.Date(timestampMs))
            .toString()
    ...
    fun formattedSize(): String =
        if (sizeBytes >
            ...
            "%.1f MB".format(sizeBytes / 1048576.0)
        } else {
            "${(sizeBytes / 1024)} KB"
        }
}
...
data class RestoreState(
    ...
    companion object {
        ...
        fun done(syncTriggered: Boolean) =
            RestoreState(
...
class BackupManager(
    ...
    fun fetchLatestBackupInfo(): Flow<BackupInfo?> =
        callbackFlow {
     ...
     */
    fun restoreFromCloud(): Flow<RestoreState> =
        callbackFlow {
    ...
    private fun triggerPostRestoreSync(): Boolean =
        try {
            val workReq =
                androidx.work
