          ...
          <div className="glass-card overflow-hidden border border-red-200 dark:border-red-900/30 rounded-xl bg-red-50/10">
            ...
            <div className="p-6">
              ...
              <div className="flex gap-2">
                <input type="text" value={purgeId} onChange={(e) => setPurgeId(e.target.value)} placeholder="Store ID to Purge" className="flex-1 p-2 border rounded-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white" />
