...
export default function QuotationsClient({
    ...
    useEffect(() => {
        ...
        const options = needsServerFetch
            ...
            : undefined;
        executeQuery(
            getSalesCountRef(dataConnect, { storeId, type: "ESTIMATE" }),
            options,
        )
            .then((res) => {
    ...
    const generatePDF = (quote: any) => {
        ...
        doc.text(
            `Customer: ${quote.customer_name || "Walk-in Customer"}`,
            14,
            40,
        );
        ...
        autoTable(doc, {
            ...
            body: [
                [
                    quote.notes || "Items as per discussion",
                    `Rs. ${displayAmount}`,
                ],
            ],
            theme: "striped",
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
                        Create and share price estimates without affecting
                        inventory.
                    </p>
                </div>
                ...
                <div className="overflow-x-auto">
                    {(() => {
                        ...
                        const filteredQuotations =
                            ...
                            !isExpired(
                                quotations.length > 0
                                    ? quotations[0]?.timestamp
                                    : 0,
                            )
                                ? quotations.filter(
                                      (q) =>
                                          !isExpired(
                                              q.timestamp ?? q.updated_at,
                                          ),
                                  )
                                : quotations;
